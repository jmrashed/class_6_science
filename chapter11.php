    ...
    <div class="book-content">
        <div  id="part1" class="parts part1 withsidenote">
            <div class="main-frame-container">
                <center><img src="images/home-chapter11.png" width="auto" title="" alt=""></center>
            </div>
        </div>

        <div id="part2" class="parts part2 withsidenote">

            <button class="btn btn-primary btn-xs sidenote">Sidenote</button>
            <div class="main-frame-container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 style="margin-top: 10px; color:#13007C">11.0 INTRODUCTION </h2>
                        <p align="justify">                    
                            To displace an object from one position to another we need to apply something on it. This something is force. Again, this force is of different types. Moreover, there are various techniques of applying force. By applying this technique work can be made much easier. Whatever is used to make this force work easily is known as simple machine. 
                        </p>
                    </div> 
                    <div class="col-md-6">
                        <h2 style="margin-top: 10px; color:#13007C">11.1 WHAT IS FORCE? </h2>
                        <p align="justify" style="line-height: 25px"> Forces are in play all around us. Things hanging, sitting, balancing, moving and spinning are all using some kind of force. Forces come in different forms and they all result in something.
                            <br>    Let us start the lesson with this short story — 
                            "Milly opened the fridge and brought out chilled can of soda. She slammed it, opened the soda and gulped it down.
                        </p>
                    </div> 
                    <div class="col-md-6">
                        <center><img src="images/shopping.png" width="auto" title="" alt="" style="padding: 10px; height: 200px"></center>
                        <p class="caption"><span class="title">Fig 11.1.1 </span>The trolley is being pushed which is a kind of force.</p>  
                    </div>
                    <div class="col-md-12  text-justify">
                        She was upset it was finished too soon and so she crushed the can in her hand and threw the empty can into the bin. " Milly applied force in many of her actions. Her actions involved the use of force to lift, open, turn, move and even change the shape of something. Force, together with its various types are applied in almost every single activity in our lives. Pushing the shopping cart, pulling the baby stroller, lifting weights at the gym, eating and many other things involve the use of some force.

                        <p style="color:#13007C; font-weight: bold;margin-top: 20px">Affect of different types of forces on an object </p>
                        <p>Let us now find out what happens when a force acts on an object. You might recall similar situations. For example, while taking a penalty kick in football, 
                            the player applies a force on the ball. Before being hit, the ball was at rest and so its speed  was zero. The applied force makes the ball move towards the goal. Suppose, the goalkeeper  dives or jumps up to save the goal. By his action the goalkeeper tries to apply a force on the moving ball. The force applied by him can stop or deflect the ball, saving a goal being scored. If the goalkeeper succeeds in stopping the ball, its speed decreases to zero.
                        </p>
                    </div> 
                    <div class="col-md-12 text-justify">
                        <center><img src="images/boy.png" width="auto" title="" alt="" style="padding: 10px; height: 400px">
                            <p class="caption" style="text-align: center!important"><span class="title"> </span>To move a tyre faster it has to be pushed repeatedly</p>  
                        </center>
                        ...
                        <br> A change in either the speed of an object, or its direction of motion, or both, is described as a change in its state of motion. Thus, a force may bring a change in the state of motion of an object.
                    </div>
                    <div class="col-md-12">

                        <p style="color:#13007C; font-weight: bold;margin-top: 20px"> State of Motion</p>
                        <p>The state of motion of an object is described by its speed and the direction of motion. The state of rest is considered to be the state of zero speed. An object may be at rest or in motion; both are its states of motion. It is common experience that many a time application of force does not result in a change in the state of motion.                        </p>
                        <P>For example, a heavy box may not move at all even if you apply the maximum force that you can exert. Again, no effect of force is observed when you try to push a wall.</P>
                    </div>
                </div>
            </div>
        ...
        <div id="part3" class="parts part3"> 
            <div class="main-frame-container">  
                <div class="row">
                    <div class="col-md-12">
                        <p style="color:#13007C; font-weight: bold;margin-top: 20px"> Change in Shape of an Object</p>
                        <p>
                            ...
                            Having performed all the above activities, you would have realised that a force:</p>
                        <div class="paddingLeft30px">•	may make an object move from rest.</div>
                        <div class="paddingLeft30px">•	may change the speed of an object if it is moving.</div>
                        <div class="paddingLeft30px">•	may change the direction of motion of an object.</div>
                        <div class="paddingLeft30px">•	may bring about a change in the shape of an object.</div>
                        <div class="paddingLeft30px">•	may cause some or all of these effects.    </div>      
                        <p style="color:#13007C; font-weight: bold;margin-top: 20px; padding: 10px">Studying the Effect of Force on Objects</p>
                        <table class="table table-bordered" >
                            <tr>
                                <th rowspan="3" style="text-align: center; vertical-align: middle;">Description of situation</th>
                                <th rowspan="3" style="text-align: center; vertical-align: middle;">How to apply force</th>
                                <th rowspan="3" style="text-align: center; vertical-align: middle;"> Diagram</th>
                                <th colspan="3" style="text-align: center; vertical-align: middle;">Action of force</th>
                            </tr>
                            <tr> <th style="text-align: center">Change in state of motion</th><th style="text-align: center">Change in shape</th>   </tr>
                            <tr> <th style="text-align: center">Yes/No</th> <th style="text-align: center">Yes/No</th> </tr>
                            <tr>
                                <td>A lump of dough on a plate</td><td>Pressing it down with your hands</td>
                                <td><img src="images/hand.png" class="img img-responsive" style="width:auto; height: 60px"></td>
                                <td style="text-align: center; vertical-align: middle;">No</td><td style="text-align: center; vertical-align: middle;">Yes</td>                                                               
                            </tr>
                            <tr>
                                <td>Spring fixed to the seat of a bicycle </td><td>By sitting on the seat</td>
                                <td><img src="images/seat.png" class="img img-responsive" style="width:auto; height: 60px"></td>
                                <td style="text-align: center; vertical-align: middle;">No</td><td style="text-align: center; vertical-align: middle;">Yes</td>                                                               
                            </tr>
                            <tr>
                                <td>A rubber band suspended from a hook/nail fixed on a wall </td><td> By hanging a weight or by pulling its free end</td>
                                <td><img src="images/pin.png" class="img img-responsive" style="width:auto; height: 60px"></td>
                                <td style="text-align: center; vertical-align: middle;">No</td><td style="text-align: center; vertical-align: middle;">Yes</td>                                                               
                            </tr>    

                            <tr>
                                <td> A plastic or metal scale placed between two bricks </td><td> By putting a weight at the center of the scale Tab </td>
                                <td><img src="images/box.png" class="img img-responsive" style="width:auto; height: 60px"></td>
                                <td style="text-align: center; vertical-align: middle;">No</td><td style="text-align: center; vertical-align: middle;">Yes</td>                                                               
                            </tr> 
